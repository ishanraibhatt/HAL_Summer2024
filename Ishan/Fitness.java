...
class CellEx extends AgentSQ2Dunstackable<Fitness>{
    int nMutations;
...
public class Fitness extends AgentGrid2D<CellEx> {
    ...
    public Fitness(int x, int y, UIGrid vis) {
        super(x, y, CellEx.class);
        this.vis=vis;
    }
    public Fitness(int x, int y, UIGrid vis, String outputFileName) {
        super(x, y, CellEx.class);
        this.vis=vis;
...
//        IncTick();//increments timestep, including newly generated cells in the next round of iteration
    ...
    public static void main(String[]args){
        ...
        Fitness grid=new Fitness(x,y,vis);
        grid.InitTumor(5);
